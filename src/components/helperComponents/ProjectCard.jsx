  ...
  return (
    <div className={`${MainStyles.RowJustifiedAround} mt-20 px-5`}>
      ...
      <div className={`text-white w-[40%] text-center ${MainStyles.Column}`}>
        <h1 className={`mt-5 font-bold select-none text-[5rem] leading-none uppercase ${MainStyles.MainHeaderGradientText}`}>
          Order Summary Card
        </h1>
        <span className='px-5 w-[95%] mt-10'>
          <p className={`text-left text-gray-200 text-2xl`}>
